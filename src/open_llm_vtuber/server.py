...
from .routes import init_client_ws_route, init_proxy_route
...
class WebSocketServer:
    """
    API server for Open-LLM-Detroit. This contains the websocket endpoint for the client, hosts the web tool, and serves static files.
    ...
    def __init__(self, config: Config, default_context_cache: ServiceContext = None):
        ...
        # Removed webtool routes since web_tool directory was removed
        # self.app.include_router(
        ...
        # Commented out since web_tool directory was removed
        # self.app.mount(
        #     "/web-tool",
